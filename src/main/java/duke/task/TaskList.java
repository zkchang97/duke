...
public class TaskList {
    ...
    /**
     * Returns list of tasks from task list with description containing the substring.
     * @param substring the substring to be found in task list.
     * @return returns list of tasks with matching substring in description.
     */
